package com.AiCapDesigns.springboot.app.controller;
...
import com.AiCapDesigns.springboot.app.repository.RoleRepository;
import com.AiCapDesigns.springboot.app.service.UserService;
...
public class UserController {
	...
	public ResponseEntity<String> postEditChangePassword(@Valid @RequestBody ChangePasswordForm form, Errors errors) {
		try{
			if(errors.hasErrors()) {
